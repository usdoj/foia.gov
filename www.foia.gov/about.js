...
$('a.video1a').qtip({
    ...
    content: {
   		...
   		text: '<div id="vid1a">To view the FOIA.gov videos, you must enable Javascript and install the Adobe Flash player.</div>',
		...
		position: {
            ...
            corner: {
               ...
               target: 'bottomMiddle' // ...and position it center of the screen
...
$('a.video12').qtip({
    ...
    content: {
   		...
   		text: '<div id="vid12">To view the FOIA.gov videos, you must enable Javascript and install the Adobe Flash player.</div>',

   		title: {

      		text: 'What are Exemptions?',
