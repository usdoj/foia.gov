...
case $YEAR in
  ...
  2024)
    ...
    ;;
  2025)
    declare -a agencies=(oncd abmc doj achp acus afrh asc ceq cfa cfpb cftc cia cigie cncs co cppbsd cpsc crccrrb csb csosa dc dfc dhs dnfsb doc dod doe doi dol dos dot eac ed eeoc epa fca fcc fcsic fdic fec ferc ffiec fhfa flra fmc fmcs fmshrc fomc frb frtib ftc gcerc gsa ha hhs hstsf hud iaf imls fpisc jmmff lsc mcc mkuf mmc mspb nara nasa ncd ncpc ncua nea neh nigc nlrb nmb nrc nrpc nsf ntsb nw nwtrb odni oge omb ondcp opm osc oshrc ostp pbgc pc pclob prc pt usrrb sba sec sigar ssa sss stb treasury tva usab usagm usaid usccr usda usibwc usitc usps ustda ustr va)
    ;;
  *)
