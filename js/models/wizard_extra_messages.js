...
const extraMessages = {
  ...
  q20: 'Is the record you seek from a state or local agency or from a federal law enforcement agency?',
  q21: 'Are you seeking records regarding any of the following:',
  q22: 'Did the incident happen on or near a military base or involve active-duty military personnel?',
  q23: 'Select the type of law enforcement record you are seeking from the list below:',
  q24: 'Did the arrest happen as a result of a:',
  q25: 'Is the prison a:',
  q26: 'Body worn camera (BWC) footage can be a part of federal, state, or local law enforcement investigations. Is the footage you seek part of a:',
  q27: 'Background checks can be conducted by federal, state, local, or private entities. Was the background check conducted by a:',
  q28: 'Was the court case a federal case or local case?',
  a1: 'Yes',
  a2: 'No',
  a3: 'A-File',
  a4: 'A-Number',
