...
import ChiefFoiaOfficersCouncilContentPage from './pages/chief_foia_officers_council_content_page';
...
render(
  <Router basename="/chief-foia-officers-council">
    <Switch>
      ...
      <Route path="/:id" exact component={ChiefFoiaOfficersCouncilContentPage} />
