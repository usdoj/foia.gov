      ...
      <div className="annual-report-data-page usa-grid" ref={(ref) => { this.element = ref; }}>
        {submissionAction === false || submissionAction === 'download' || viewMode === 'form' ?
          <div>
            ...
            <p>Annual Reports shine a light on agencies' administration of the FOIA by providing members of the public with detailed FOIA statistics. Users can filter data by agency, data type, and fiscal year. Users can also compare data across years and agencies. Annual Report data is displayed as a chart on FOIA.gov and can also be downloaded as a CSV file.  For full data sets from agency Annual Reports, please visit <a href="/developer/">the Developer page</a>.</p>
            <form >
