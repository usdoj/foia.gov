...
class QuarterlyReportDataTypeFilter extends Component {
  constructor(props) {
    super(props);
  ...
  handleDataTypeChange(e) {
    ...
    dispatcher.dispatch({
      type: types.QUARTERLY_REPORT_DATA_TYPE_UPDATE,
  ...
  handleFilterFieldUpdate(e) {
    ...
    dispatcher.dispatch({
      type: types.QUARTERLY_REPORT_DATA_TYPE_FILTER_UPDATE,
  ...
  handleModalSubmit() {
    dispatcher.dispatch({
      type: types.QUARTERLY_REPORT_DATA_TYPE_FILTER_SUBMIT,
      index: this.props.selectedDataType.index,
    });
  }
  ...
  handleFilterReset() {
    dispatcher.dispatch({
      type: types.QUARTERLY_REPORT_DATA_TYPE_FILTER_RESET,
      index: this.props.selectedDataType.index,
    });
  }
  ...
  handleFilterRemove(e) {
    ...
    dispatcher.dispatch({
      type: types.QUARTERLY_REPORT_DATA_TYPE_FILTER_REMOVE,
          ...
          <USWDSSelectWidget
            ...
            title={(
              <span>
                Data Filters
                <FoiaTooltip
                  text={'Select the type of FOIA data you would like to view. The data comes from agencies\' Quarterly FOIA Reports. To learn more about the data, view the terms in the Glossary.'}
                />
              </span>
            )}
...
QuarterlyReportDataTypeFilter.propTypes = {
...
QuarterlyReportDataTypeFilter.defaultProps = {
  dataTypeOptions: new List(),
  selectedDataType: { index: 0, id: '' },
};

export default QuarterlyReportDataTypeFilter;
